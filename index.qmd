...
[However, creating function can lead to unexpected warnings and errors. To view these issues, I use some functions from the [***collateral***](https://collateral.jamesgoldie.dev/) R package.]{style="font-size: 150%;" target="_blank"}
:::
...
Tidying up formatted Excel files remains challenging but there are ways to do this in R without too much manual work. R packages ([***pointblank***](https://rstudio.github.io/pointblank/){target="_blank"}, [***collateral***](https://collateral.jamesgoldie.dev/){target="_blank"}, [***tidyxl***](https://nacnudus.github.io/tidyxl/index.html){target="_blank"}) can help to validate and tackle these problematic columns.
