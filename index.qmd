...
Here is one that I have made called [sample_excel.xlsx](https://raw.githubusercontent.com/JauntyJJS/useR-2024/main//sample_excel.xlsx).
...
Businessman sitting at office and feeling dull because lack of idea by [Amonrat Rungreangfangsai](https://www.vecteezy.com/vector-art/464584-business-man-sitting-at-office-and-feeling-dull-because-lack-of-idea-to-work)
...
Thankfully, there are some R packages ([***pointblank***](https://rstudio.github.io/pointblank/), [***collateral***](https://collateral.jamesgoldie.dev/), [***tidyxl***](https://nacnudus.github.io/tidyxl/index.html)) that can help
...
Wind-up businessman image by [Amonrat Rungreangfangsai](https://www.vecteezy.com/vector-art/464469-wind-up-businessman-end-of-energy-and-stop-working)
...
However, we also cannot use [***pointblank::col_vals_regex***](https://rstudio.github.io/pointblank/reference/col_vals_regex.html) because the column is not read in text.
...
[Use [***pointblank::test_col_vals_in_set***](https://rstudio.github.io/pointblank/reference/col_vals_in_set.html) to ensure that the column only contains values from a user-defined set.]{style="font-size: 90%;"}
...
[However, creating function can lead to unexpected warnings and errors. To view these issues, I use some functions from the [***collateral***](https://collateral.jamesgoldie.dev/) R package.]{style="font-size: 150%;"}
:::

-  [***collateral::map_peacefully***](https://collateral.jamesgoldie.dev/reference/collateral_mappers)
-  [***collateral::has_warnings***](https://collateral.jamesgoldie.dev/reference/has) and [***collateral::has_errors***](https://collateral.jamesgoldie.dev/reference/has)
...
Use [***tidyxl::xlsx_formats***](https://nacnudus.github.io/tidyxl/reference/xlsx_formats.html) to obtain the format information of the excel file in a list.
...
Next, use https://www.schemecolor.com/?getcolor={hex code} (<https://www.schemecolor.com/sample?getcolor=00B050> in our running example) to find out what the Hex8 code is for the [**green**]{style="color: #00B050"} font.
...
Tidying up formatted Excel files remains challenging but there are ways to do this in R without too much manual work. R packages ([***pointblank***](https://rstudio.github.io/pointblank/), [***collateral***](https://collateral.jamesgoldie.dev/), [***tidyxl***](https://nacnudus.github.io/tidyxl/index.html)) can help to validate and tackle these problematic columns.

Hope that it encouraging others to find or share alternative ways. 
...
Businessman sitting at stack of books, read a book and dreaming about success by [Amonrat Rungreangfangsai](https://www.vecteezy.com/vector-art/464918-businessman-sit-at-stack-of-books-read-a-book-and-dreaming-about-success)
