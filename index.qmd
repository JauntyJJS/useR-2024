...
::: {.column width="50%"}
![Wind-up businessman images by [Amonrat Rungreangfangsai](https://www.vecteezy.com/vector-art/464469-wind-up-businessman-end-of-energy-and-stop-working)](images/manual_cleaning.jpg){fig-alt="Image of a businessman cleaning up."}
:::
...
![](images/packages.png){fig-alt="Image of R pacakges pointblank, collateral and tidyxl."}
:::
...
Identify the `local_format_id` accordingly with the **black** and [**green**]{style="color: #00B050"} Hex8 code as #FF000000 and #FF00B050 respectively.
